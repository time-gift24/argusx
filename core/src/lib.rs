...
impl Builtin {
    pub fn canonical_name(&self) -> &str {
        match self {
            ...
            Self::DispatchSubagent => "dispatch_subagent",
            Self::ListSubagentDispatches => "list_subagent_dispatches",
            Self::GetSubagentDispatch => "get_subagent_dispatch",
            Self::Shell => "shell",
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        Some(match name {
            ...
            "dispatch_subagent" => Self::DispatchSubagent,
            "list_subagent_dispatches" => Self::ListSubagentDispatches,
            "get_subagent_dispatch" => Self::GetSubagentDispatch,
            "shell" => Self::Shell,
